...
@:keep @:dox(hide) class ManifestResources {
	...
	public static function init (config:Dynamic):Void {
		...
		openfl.text.Font.registerFont (__ASSET__OPENFL__fonts_matrixextrabold_ttf);
		openfl.text.Font.registerFont (__ASSET__OPENFL__fonts_matrixliningregular_ttf);
		openfl.text.Font.registerFont (__ASSET__OPENFL__fonts_matrixregular_ttf);
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__fonts_matrixextrabold_ttf extends null { }
...
@:keep @:noCompletion #if display private #end class __ASSET__fonts_matrixextrabold_ttf extends lime.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "fonts/MatrixExtraBold.ttf"; name = "MatrixExtraBold"; super (); }}
@:keep @:noCompletion #if display private #end class __ASSET__fonts_matrixliningregular_ttf extends lime.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "fonts/MatrixliningRegular.ttf"; name = "MatrixLining"; super (); }}
@:keep @:noCompletion #if display private #end class __ASSET__fonts_matrixregular_ttf extends lime.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "fonts/MatrixRegular.ttf"; name = "MatrixRegular"; super (); }}
...
@:keep @:expose('__ASSET__fonts_matrixextrabold_ttf') @:noCompletion #if display private #end class __ASSET__fonts_matrixextrabold_ttf extends lime.text.Font { public function new () { #if !html5 __fontPath = "fonts/MatrixExtraBold.ttf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "MatrixExtraBold"; super (); }}
@:keep @:expose('__ASSET__fonts_matrixliningregular_ttf') @:noCompletion #if display private #end class __ASSET__fonts_matrixliningregular_ttf extends lime.text.Font { public function new () { #if !html5 __fontPath = "fonts/MatrixliningRegular.ttf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "MatrixLining"; super (); }}
@:keep @:expose('__ASSET__fonts_matrixregular_ttf') @:noCompletion #if display private #end class __ASSET__fonts_matrixregular_ttf extends lime.text.Font { public function new () { #if !html5 __fontPath = "fonts/MatrixRegular.ttf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "MatrixRegular"; super (); }}
...
@:keep @:expose('__ASSET__OPENFL__fonts_matrixextrabold_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__fonts_matrixextrabold_ttf extends openfl.text.Font { public function new () { name = "MatrixExtraBold"; super (); }}
@:keep @:expose('__ASSET__OPENFL__fonts_matrixliningregular_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__fonts_matrixliningregular_ttf extends openfl.text.Font { public function new () { name = "MatrixLining"; super (); }}
@:keep @:expose('__ASSET__OPENFL__fonts_matrixregular_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__fonts_matrixregular_ttf extends openfl.text.Font { public function new () { name = "MatrixRegular"; super (); }}
...
@:keep @:expose('__ASSET__OPENFL__fonts_matrixextrabold_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__fonts_matrixextrabold_ttf extends openfl.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "fonts/MatrixExtraBold.ttf"; name = "MatrixExtraBold"; super (); }}
@:keep @:expose('__ASSET__OPENFL__fonts_matrixliningregular_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__fonts_matrixliningregular_ttf extends openfl.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "fonts/MatrixliningRegular.ttf"; name = "MatrixLining"; super (); }}
@:keep @:expose('__ASSET__OPENFL__fonts_matrixregular_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__fonts_matrixregular_ttf extends openfl.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "fonts/MatrixRegular.ttf"; name = "MatrixRegular"; super (); }}
