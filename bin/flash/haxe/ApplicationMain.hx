...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("VTESCardMaker", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("VTESCardMaker", null, 600, 800);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["packageName"] = "com.nbigot.vtescardmaker";
