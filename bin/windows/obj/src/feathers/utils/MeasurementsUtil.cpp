...
HXLINE(  33)		if (::Std_obj::isOfType(target,( ( ::Dynamic)(::hx::ClassOf< ::feathers::core::IMeasureObject >()) ))) {
...
HXLINE(  79)				maxWidth = ::Math_obj::POSITIVE_INFINITY;
            			}
...
HXLINE(  88)				maxHeight = ::Math_obj::POSITIVE_INFINITY;
            			}
