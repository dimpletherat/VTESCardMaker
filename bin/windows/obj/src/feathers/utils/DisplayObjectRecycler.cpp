...
HX_LOCAL_STACK_FRAME(_hx_pos_827c4d25b15f5e0c_68___default_update,"feathers.utils.DisplayObjectRecycler","__default_update",0x3b199e90,"feathers.utils.DisplayObjectRecycler.__default_update","feathers/utils/DisplayObjectRecycler.hx",68,0x83c95c7b)
HX_LOCAL_STACK_FRAME(_hx_pos_827c4d25b15f5e0c_77___default_reset,"feathers.utils.DisplayObjectRecycler","__default_reset",0x4b76df28,"feathers.utils.DisplayObjectRecycler.__default_reset","feathers/utils/DisplayObjectRecycler.hx",77,0x83c95c7b)
HX_LOCAL_STACK_FRAME(_hx_pos_827c4d25b15f5e0c_85___default_create,"feathers.utils.DisplayObjectRecycler","__default_create",0x30237f83,"feathers.utils.DisplayObjectRecycler.__default_create","feathers/utils/DisplayObjectRecycler.hx",85,0x83c95c7b)
HX_LOCAL_STACK_FRAME(_hx_pos_827c4d25b15f5e0c_93___default_destroy,"feathers.utils.DisplayObjectRecycler","__default_destroy",0x02078a93,"feathers.utils.DisplayObjectRecycler.__default_destroy","feathers/utils/DisplayObjectRecycler.hx",93,0x83c95c7b)
...
HX_LOCAL_STACK_FRAME(_hx_pos_827c4d25b15f5e0c_33_withClass,"feathers.utils.DisplayObjectRecycler","withClass",0xfb4edec9,"feathers.utils.DisplayObjectRecycler.withClass","feathers/utils/DisplayObjectRecycler.hx",33,0x83c95c7b)
HX_LOCAL_STACK_FRAME(_hx_pos_827c4d25b15f5e0c_49_withFunction,"feathers.utils.DisplayObjectRecycler","withFunction",0xeab7f527,"feathers.utils.DisplayObjectRecycler.withFunction","feathers/utils/DisplayObjectRecycler.hx",49,0x83c95c7b)
namespace feathers{
namespace utils{
...
void _hx_run( ::Dynamic target, ::Dynamic state){
            	HX_STACKFRAME(&_hx_pos_827c4d25b15f5e0c_68___default_update)
            	}
...
void _hx_run( ::Dynamic target, ::Dynamic state){
            	HX_STACKFRAME(&_hx_pos_827c4d25b15f5e0c_77___default_reset)
            	}
HX_END_LOCAL_FUNC2((void))
HX_END_DEFAULT_FUNC

HX_BEGIN_DEFAULT_FUNC(__default_create,DisplayObjectRecycler_obj)
 ::Dynamic _hx_run(){
            	HX_STACKFRAME(&_hx_pos_827c4d25b15f5e0c_85___default_create)
HXDLIN(  85)		return null();
            	}
HX_END_LOCAL_FUNC0(return )
HX_END_DEFAULT_FUNC

HX_BEGIN_DEFAULT_FUNC(__default_destroy,DisplayObjectRecycler_obj)
void _hx_run( ::Dynamic target){
            	HX_STACKFRAME(&_hx_pos_827c4d25b15f5e0c_93___default_destroy)
            	}
...
HXLINE(  35)			return ::Type_obj::createInstance(displayObjectType,::cpp::VirtualArray_obj::__new(0));
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_GC_STACKFRAME(&_hx_pos_827c4d25b15f5e0c_33_withClass)
HXLINE(  34)		 ::feathers::utils::DisplayObjectRecycler item =  ::feathers::utils::DisplayObjectRecycler_obj::__alloc( HX_CTX );
HXLINE(  35)		item->create =  ::Dynamic(new _hx_Closure_0(displayObjectType));
HXLINE(  38)		item->update = update;
HXLINE(  39)		item->reset = reset;
HXLINE(  40)		item->destroy = destroy;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(DisplayObjectRecycler_obj,withClass,return )
 ...
 ::feathers::utils::DisplayObjectRecycler DisplayObjectRecycler_obj::withFunction( ::Dynamic create, ::Dynamic update, ::Dynamic reset, ::Dynamic destroy){
            	HX_GC_STACKFRAME(&_hx_pos_827c4d25b15f5e0c_49_withFunction)
HXLINE(  50)		 ::feathers::utils::DisplayObjectRecycler item =  ::feathers::utils::DisplayObjectRecycler_obj::__alloc( HX_CTX );
HXLINE(  51)		item->create = create;
HXLINE(  52)		item->update = update;
HXLINE(  53)		item->reset = reset;
HXLINE(  54)		item->destroy = destroy;
HXLINE(  55)		return item;
            	}
...
static ::hx::StorageInfo DisplayObjectRecycler_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(DisplayObjectRecycler_obj,create),HX_("create",fc,66,0f,7c)},
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(DisplayObjectRecycler_obj,destroy),HX_("destroy",fa,2c,86,24)},
	{ ::hx::fsUnknown, 0, null()}
};
