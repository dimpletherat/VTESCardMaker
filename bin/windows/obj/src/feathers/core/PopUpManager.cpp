...
HX_LOCAL_STACK_FRAME(_hx_pos_9a5059dfeb5c0e71_92_dispose,"feathers.core.PopUpManager","dispose",0x598d7b43,"feathers.core.PopUpManager.dispose","feathers/core/PopUpManager.hx",92,0xbc04f28c)
HX_LOCAL_STACK_FRAME(_hx_pos_9a5059dfeb5c0e71_107_addPopUp,"feathers.core.PopUpManager","addPopUp",0x1a8c6947,"feathers.core.PopUpManager.addPopUp","feathers/core/PopUpManager.hx",107,0xbc04f28c)
HX_LOCAL_STACK_FRAME(_hx_pos_9a5059dfeb5c0e71_124_removePopUp,"feathers.core.PopUpManager","removePopUp",0x1dc5e80c,"feathers.core.PopUpManager.removePopUp","feathers/core/PopUpManager.hx",124,0xbc04f28c)
HX_LOCAL_STACK_FRAME(_hx_pos_9a5059dfeb5c0e71_139_removeAllPopUps,"feathers.core.PopUpManager","removeAllPopUps",0xccafea68,"feathers.core.PopUpManager.removeAllPopUps","feathers/core/PopUpManager.hx",139,0xbc04f28c)
HX_LOCAL_STACK_FRAME(_hx_pos_9a5059dfeb5c0e71_151_centerPopUp,"feathers.core.PopUpManager","centerPopUp",0xf16210db,"feathers.core.PopUpManager.centerPopUp","feathers/core/PopUpManager.hx",151,0xbc04f28c)
HX_LOCAL_STACK_FRAME(_hx_pos_9a5059dfeb5c0e71_167_isPopUp,"feathers.core.PopUpManager","isPopUp",0x015b8ca6,"feathers.core.PopUpManager.isPopUp","feathers/core/PopUpManager.hx",167,0xbc04f28c)
HX_LOCAL_STACK_FRAME(_hx_pos_9a5059dfeb5c0e71_186_isModal,"feathers.core.PopUpManager","isModal",0x471ebe87,"feathers.core.PopUpManager.isModal","feathers/core/PopUpManager.hx",186,0xbc04f28c)
HX_LOCAL_STACK_FRAME(_hx_pos_9a5059dfeb5c0e71_205_isTopLevelPopUp,"feathers.core.PopUpManager","isTopLevelPopUp",0xb3dba977,"feathers.core.PopUpManager.isTopLevelPopUp","feathers/core/PopUpManager.hx",205,0xbc04f28c)
HX_LOCAL_STACK_FRAME(_hx_pos_9a5059dfeb5c0e71_218_defaultPopUpManagerFactory,"feathers.core.PopUpManager","defaultPopUpManagerFactory",0xb07870e4,"feathers.core.PopUpManager.defaultPopUpManagerFactory","feathers/core/PopUpManager.hx",218,0xbc04f28c)
...
void PopUpManager_obj::dispose(){
            	HX_STACKFRAME(&_hx_pos_9a5059dfeb5c0e71_92_dispose)
HXLINE(  93)		::feathers::core::PopUpManager_obj::removeAllPopUps();
HXLINE(  94)		{
HXLINE(  94)			 ::Dynamic stage = ::feathers::core::PopUpManager_obj::stageToManager->keys();
HXDLIN(  94)			while(( (bool)(stage->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  94)				 ::openfl::display::Stage stage1 = ( ( ::openfl::display::Stage)(stage->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  95)				::feathers::core::PopUpManager_obj::stageToManager->remove(stage1);
            			}
            		}
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(PopUpManager_obj,dispose,(void))
 ...
 ::openfl::display::DisplayObject PopUpManager_obj::addPopUp( ::openfl::display::DisplayObject popUp, ::openfl::display::DisplayObject parent,::hx::Null< bool >  __o_isModal,::hx::Null< bool >  __o_isCentered, ::Dynamic customOverlayFactory){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_9a5059dfeb5c0e71_107_addPopUp)
HXLINE( 108)		if (::hx::IsNull( parent )) {
HXLINE( 109)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,HX_("The pop-up's parent must not be null.",86,19,25,c6))));
            		}
HXLINE( 111)		 ::openfl::display::Stage stage = parent->stage;
HXLINE( 112)		if (::hx::IsNull( stage )) {
HXLINE( 113)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,HX_("The stage property of a pop-up's parent must not be null.",07,9e,12,e3))));
            		}
HXLINE( 115)		::Dynamic popUpManager = ::feathers::core::PopUpManager_obj::forStage(stage);
HXLINE( 116)		return ::feathers::core::IPopUpManager_obj::addPopUp(popUpManager,popUp,isModal,isCentered,customOverlayFactory);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC5(PopUpManager_obj,addPopUp,return )
 ...
 ::openfl::display::DisplayObject PopUpManager_obj::removePopUp( ::openfl::display::DisplayObject popUp){
            	HX_STACKFRAME(&_hx_pos_9a5059dfeb5c0e71_124_removePopUp)
HXLINE( 125)		 ::openfl::display::Stage stage = popUp->stage;
HXLINE( 126)		if (::hx::IsNull( stage )) {
HXLINE( 127)			return popUp;
            		}
HXLINE( 129)		::Dynamic popUpManager = ::feathers::core::PopUpManager_obj::forStage(stage);
HXLINE( 130)		return ::feathers::core::IPopUpManager_obj::removePopUp(popUpManager,popUp);
            	}
...
void PopUpManager_obj::removeAllPopUps(){
            	HX_STACKFRAME(&_hx_pos_9a5059dfeb5c0e71_139_removeAllPopUps)
HXDLIN( 139)		 ::Dynamic popUpManager = ::feathers::core::PopUpManager_obj::stageToManager->iterator();
HXDLIN( 139)		while(( (bool)(popUpManager->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 139)			::Dynamic popUpManager1 = popUpManager->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXLINE( 140)			::feathers::core::IPopUpManager_obj::removeAllPopUps(popUpManager1);
            		}
            	}
...
void PopUpManager_obj::centerPopUp( ::openfl::display::DisplayObject target){
            	HX_GC_STACKFRAME(&_hx_pos_9a5059dfeb5c0e71_151_centerPopUp)
HXLINE( 152)		 ::openfl::display::Stage stage = target->stage;
HXLINE( 153)		if (::hx::IsNull( stage )) {
HXLINE( 154)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,HX_("A pop-up's stage property must not be null.",83,d3,62,54))));
            		}
HXLINE( 156)		::Dynamic popUpManager = ::feathers::core::PopUpManager_obj::forStage(stage);
HXLINE( 157)		::feathers::core::IPopUpManager_obj::centerPopUp(popUpManager,target);
            	}
...
bool PopUpManager_obj::isPopUp( ::openfl::display::DisplayObject target){
            	HX_STACKFRAME(&_hx_pos_9a5059dfeb5c0e71_167_isPopUp)
HXLINE( 168)		if (::hx::IsNull( target )) {
HXLINE( 169)			return false;
            		}
HXLINE( 171)		 ::openfl::display::Stage stage = target->stage;
HXLINE( 172)		if (::hx::IsNull( stage )) {
HXLINE( 173)			return false;
            		}
HXLINE( 175)		::Dynamic popUpManager = ::feathers::core::PopUpManager_obj::forStage(stage);
HXLINE( 176)		return ::feathers::core::IPopUpManager_obj::isPopUp(popUpManager,target);
            	}
...
bool PopUpManager_obj::isModal( ::openfl::display::DisplayObject target){
            	HX_STACKFRAME(&_hx_pos_9a5059dfeb5c0e71_186_isModal)
HXLINE( 187)		if (::hx::IsNull( target )) {
HXLINE( 188)			return false;
            		}
HXLINE( 190)		 ::openfl::display::Stage stage = target->stage;
HXLINE( 191)		if (::hx::IsNull( stage )) {
HXLINE( 192)			return false;
            		}
HXLINE( 194)		::Dynamic popUpManager = ::feathers::core::PopUpManager_obj::forStage(stage);
HXLINE( 195)		return ::feathers::core::IPopUpManager_obj::isModal(popUpManager,target);
            	}
...
bool PopUpManager_obj::isTopLevelPopUp( ::openfl::display::DisplayObject target){
            	HX_STACKFRAME(&_hx_pos_9a5059dfeb5c0e71_205_isTopLevelPopUp)
HXLINE( 206)		if (::hx::IsNull( target )) {
HXLINE( 207)			return false;
            		}
HXLINE( 209)		 ::openfl::display::Stage stage = target->stage;
HXLINE( 210)		if (::hx::IsNull( stage )) {
HXLINE( 211)			return false;
            		}
HXLINE( 213)		::Dynamic popUpManager = ::feathers::core::PopUpManager_obj::forStage(stage);
HXLINE( 214)		return ::feathers::core::IPopUpManager_obj::isTopLevelPopUp(popUpManager,target);
            	}
...
::Dynamic PopUpManager_obj::defaultPopUpManagerFactory( ::openfl::display::Stage stage){
            	HX_GC_STACKFRAME(&_hx_pos_9a5059dfeb5c0e71_218_defaultPopUpManagerFactory)
HXDLIN( 218)		return  ::feathers::core::DefaultPopUpManager_obj::__alloc( HX_CTX ,stage);
            	}
