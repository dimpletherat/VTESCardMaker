...
HX_DEFINE_STACK_FRAME(_hx_pos_b28af5e792945e57_33_new,"feathers.themes.ClassVariantTheme","new",0x4fc39f88,"feathers.themes.ClassVariantTheme.new","feathers/themes/ClassVariantTheme.hx",33,0x0198eb08)
HX_LOCAL_STACK_FRAME(_hx_pos_b28af5e792945e57_36_getStyleProvider,"feathers.themes.ClassVariantTheme","getStyleProvider",0xd1bbece4,"feathers.themes.ClassVariantTheme.getStyleProvider","feathers/themes/ClassVariantTheme.hx",36,0x0198eb08)
HX_LOCAL_STACK_FRAME(_hx_pos_b28af5e792945e57_85_dispose,"feathers.themes.ClassVariantTheme","dispose",0xe85703c7,"feathers.themes.ClassVariantTheme.dispose","feathers/themes/ClassVariantTheme.hx",85,0x0198eb08)
namespace feathers{
namespace themes{

void ClassVariantTheme_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_b28af5e792945e57_33_new)
HXDLIN(  33)		this->styleProvider =  ::feathers::style::ClassVariantStyleProvider_obj::__alloc( HX_CTX );
            	}
...
::Dynamic ClassVariantTheme_obj::getStyleProvider(::Dynamic target){
            	HX_STACKFRAME(&_hx_pos_b28af5e792945e57_36_getStyleProvider)
HXLINE(  37)		::hx::Class styleContext = null();
HXLINE(  38)		::String variant = null();
HXLINE(  39)		if (::Std_obj::isOfType(target,( ( ::Dynamic)(::hx::ClassOf< ::feathers::style::IVariantStyleObject >()) ))) {
HXLINE(  40)			::Dynamic variantObject = target;
HXLINE(  41)			styleContext = ::feathers::style::IVariantStyleObject_obj::get_styleContext(variantObject);
HXLINE(  42)			variant = ( (::String)(variantObject->__Field(HX_("variant",85,40,e2,dc),::hx::paccDynamic)) );
            		}
HXLINE(  44)		if (::hx::IsNull( styleContext )) {
HXLINE(  45)			styleContext = ::Type_obj::getClass(target);
            		}
HXLINE(  48)		 ::Dynamic styleFunction = this->styleProvider->getStyleFunction(styleContext,variant);
HXLINE(  49)		if (::hx::IsNotNull( styleFunction )) {
HXLINE(  50)			return this->styleProvider;
            		}
HXLINE(  52)		if (::hx::IsNull( variant )) {
HXLINE(  55)			return null();
            		}
HXLINE(  59)		::Dynamic fallbackTheme = ::feathers::style::Theme_obj::get_fallbackTheme();
HXLINE(  60)		bool _hx_tmp;
HXDLIN(  60)		bool _hx_tmp1;
HXDLIN(  60)		if (::hx::IsNotNull( fallbackTheme )) {
HXLINE(  60)			_hx_tmp1 = ::hx::IsNotEq( fallbackTheme,::hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
HXLINE(  60)			_hx_tmp1 = false;
            		}
HXDLIN(  60)		if (_hx_tmp1) {
HXLINE(  60)			_hx_tmp = ::Std_obj::isOfType(fallbackTheme,( ( ::Dynamic)(::hx::ClassOf< ::feathers::themes::ClassVariantTheme >()) ));
            		}
            		else {
HXLINE(  60)			_hx_tmp = false;
            		}
HXDLIN(  60)		if (_hx_tmp) {
HXLINE(  65)			 ::feathers::style::ClassVariantStyleProvider fallbackStyleProvider = ( ( ::feathers::style::ClassVariantStyleProvider)(::Std_obj::downcast(::feathers::style::ITheme_obj::getStyleProvider(fallbackTheme,target),::hx::ClassOf< ::feathers::style::ClassVariantStyleProvider >())) );
HXLINE(  66)			if (::hx::IsNotNull( fallbackStyleProvider )) {
HXLINE(  67)				 ::Dynamic styleFunction = fallbackStyleProvider->getStyleFunction(styleContext,variant);
HXLINE(  68)				if (::hx::IsNotNull( styleFunction )) {
HXLINE(  69)					return null();
            				}
            			}
            		}
HXLINE(  75)		styleFunction = this->styleProvider->getStyleFunction(styleContext,null());
HXLINE(  76)		if (::hx::IsNotNull( styleFunction )) {
HXLINE(  77)			return this->styleProvider;
            		}
...
void ClassVariantTheme_obj::dispose(){
            	HX_STACKFRAME(&_hx_pos_b28af5e792945e57_85_dispose)
HXDLIN(  85)		::feathers::events::FeathersEvent_obj::dispatch(this->styleProvider,HX_("clear",8d,71,5b,48),null(),null());
            	}
