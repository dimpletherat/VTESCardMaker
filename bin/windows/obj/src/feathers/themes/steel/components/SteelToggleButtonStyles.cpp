...
HXLINE(  39)					skin->set_selectedFill(theme->getThemeFill());
HXLINE(  40)					skin->setFillForState(::feathers::controls::ToggleButtonState_obj::DOWN(false),theme->getReversedActiveThemeFill());
HXLINE(  41)					skin->setFillForState(::feathers::controls::ToggleButtonState_obj::DISABLED(false),theme->getButtonDisabledFill());
HXLINE(  42)					skin->setFillForState(::feathers::controls::ToggleButtonState_obj::DOWN(false),theme->getReversedActiveThemeFill());
HXLINE(  43)					skin->set_border(theme->getButtonBorder(null()));
HXLINE(  44)					skin->set_selectedBorder(theme->getActiveFillBorder(null()));
HXLINE(  45)					skin->setBorderForState(::feathers::controls::ToggleButtonState_obj::DOWN(false),theme->getActiveFillBorder(null()));
HXLINE(  46)					skin->set_cornerRadius(((Float)6.0));
HXLINE(  47)					button->set_backgroundSkin(skin);
            				}
HXLINE(  50)				if (::hx::IsNull( button->get_focusRectSkin() )) {
HXLINE(  51)					 ::feathers::skins::RectangleSkin skin =  ::feathers::skins::RectangleSkin_obj::__alloc( HX_CTX );
HXLINE(  52)					skin->set_fill(null());
HXLINE(  53)					skin->set_border(theme->getActiveFillBorder(null()));
HXLINE(  54)					skin->set_cornerRadius(((Float)6.0));
HXLINE(  55)					button->set_focusRectSkin(skin);
            				}
HXLINE(  58)				if (::hx::IsNull( button->textFormat )) {
HXLINE(  59)					button->set_textFormat(theme->getTextFormat());
            				}
HXLINE(  61)				if (::hx::IsNull( button->disabledTextFormat )) {
HXLINE(  62)					button->set_disabledTextFormat(theme->getDisabledTextFormat());
            				}
HXLINE(  64)				if (::hx::IsNull( button->selectedTextFormat )) {
HXLINE(  65)					button->set_selectedTextFormat(theme->getActiveTextFormat());
            				}
HXLINE(  68)				if (::hx::IsNull( button->getTextFormatForState(::feathers::controls::ToggleButtonState_obj::DOWN(false)) )) {
HXLINE(  69)					button->setTextFormatForState(::feathers::controls::ToggleButtonState_obj::DOWN(false),theme->getActiveTextFormat());
            				}
HXLINE(  72)				button->set_paddingTop(((Float)4.0));
HXLINE(  73)				button->set_paddingRight(((Float)10.0));
HXLINE(  74)				button->set_paddingBottom(((Float)4.0));
HXLINE(  75)				button->set_paddingLeft(((Float)10.0));
HXLINE(  76)				button->set_gap(((Float)6.0));
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE(  35)			styleProvider->setStyleFunction(::hx::ClassOf< ::feathers::controls::ToggleButton >(),null(), ::Dynamic(new _hx_Closure_0(theme)));
            		}
            	}
