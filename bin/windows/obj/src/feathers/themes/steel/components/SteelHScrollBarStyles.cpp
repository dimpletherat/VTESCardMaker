...
HXLINE(  39)				if (::hx::IsNull( scrollBar->thumbSkin )) {
HXLINE(  40)					 ::feathers::skins::RectangleSkin thumbSkin =  ::feathers::skins::RectangleSkin_obj::__alloc( HX_CTX );
HXLINE(  41)					thumbSkin->set_fill(theme->getOverlayFill());
HXLINE(  42)					Float size;
HXDLIN(  42)					if (isDesktop) {
HXLINE(  42)						size = ((Float)6.0);
            					}
            					else {
HXLINE(  42)						size = ((Float)4.0);
            					}
HXLINE(  43)					thumbSkin->set_width(size);
HXLINE(  44)					thumbSkin->set_height(size);
HXLINE(  45)					thumbSkin->set_minWidth(size);
HXLINE(  46)					thumbSkin->set_minHeight(size);
HXLINE(  47)					thumbSkin->set_cornerRadius(size);
HXLINE(  49)					 ::feathers::controls::BasicButton thumb =  ::feathers::controls::BasicButton_obj::__alloc( HX_CTX );
HXLINE(  50)					thumb->set_keepDownStateOnRollOut(true);
HXLINE(  51)					thumb->set_backgroundSkin(thumbSkin);
HXLINE(  52)					scrollBar->set_thumbSkin(thumb);
            				}
HXLINE(  55)				bool _hx_tmp;
HXDLIN(  55)				if (isDesktop) {
HXLINE(  55)					_hx_tmp = ::hx::IsNull( scrollBar->trackSkin );
            				}
            				else {
HXLINE(  55)					_hx_tmp = false;
            				}
HXDLIN(  55)				if (_hx_tmp) {
HXLINE(  56)					 ::feathers::skins::RectangleSkin trackSkin =  ::feathers::skins::RectangleSkin_obj::__alloc( HX_CTX );
HXLINE(  57)					trackSkin->set_fill(theme->getControlFill());
HXLINE(  58)					trackSkin->set_width(((Float)12.0));
HXLINE(  59)					trackSkin->set_height(((Float)12.0));
HXLINE(  60)					trackSkin->set_minWidth(((Float)12.0));
HXLINE(  61)					trackSkin->set_minHeight(((Float)12.0));
HXLINE(  62)					scrollBar->set_trackSkin(trackSkin);
            				}
HXLINE(  65)				scrollBar->set_paddingTop(((Float)2.0));
HXLINE(  66)				scrollBar->set_paddingRight(((Float)2.0));
HXLINE(  67)				scrollBar->set_paddingBottom(((Float)2.0));
HXLINE(  68)				scrollBar->set_paddingLeft(((Float)2.0));
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE(  36)			styleProvider->setStyleFunction(::hx::ClassOf< ::feathers::controls::HScrollBar >(),null(), ::Dynamic(new _hx_Closure_0(theme)));
            		}
            	}
