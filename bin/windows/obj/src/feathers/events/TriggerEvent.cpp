...
HX_DEFINE_STACK_FRAME(_hx_pos_9ff7555387fc5f6c_163_new,"feathers.events.TriggerEvent","new",0x737dc94b,"feathers.events.TriggerEvent.new","feathers/events/TriggerEvent.hx",163,0x10cd1a65)
HX_LOCAL_STACK_FRAME(_hx_pos_9ff7555387fc5f6c_296_clone,"feathers.events.TriggerEvent","clone",0x54ad5d08,"feathers.events.TriggerEvent.clone","feathers/events/TriggerEvent.hx",296,0x10cd1a65)
HX_LOCAL_STACK_FRAME(_hx_pos_9ff7555387fc5f6c_52_dispatchFromMouseEvent,"feathers.events.TriggerEvent","dispatchFromMouseEvent",0x9d6a280e,"feathers.events.TriggerEvent.dispatchFromMouseEvent","feathers/events/TriggerEvent.hx",52,0x10cd1a65)
HX_LOCAL_STACK_FRAME(_hx_pos_9ff7555387fc5f6c_74_dispatchFromTouchEvent,"feathers.events.TriggerEvent","dispatchFromTouchEvent",0x792e1834,"feathers.events.TriggerEvent.dispatchFromTouchEvent","feathers/events/TriggerEvent.hx",74,0x10cd1a65)
HX_LOCAL_STACK_FRAME(_hx_pos_9ff7555387fc5f6c_91_fromMouseEvent,"feathers.events.TriggerEvent","fromMouseEvent",0x5420b6b4,"feathers.events.TriggerEvent.fromMouseEvent","feathers/events/TriggerEvent.hx",91,0x10cd1a65)
HX_LOCAL_STACK_FRAME(_hx_pos_9ff7555387fc5f6c_128_fromTouchEvent,"feathers.events.TriggerEvent","fromTouchEvent",0x2fe4a6da,"feathers.events.TriggerEvent.fromTouchEvent","feathers/events/TriggerEvent.hx",128,0x10cd1a65)
HX_LOCAL_STACK_FRAME(_hx_pos_9ff7555387fc5f6c_33_boot,"feathers.events.TriggerEvent","boot",0x92ab58e7,"feathers.events.TriggerEvent.boot","feathers/events/TriggerEvent.hx",33,0x10cd1a65)
HX_LOCAL_STACK_FRAME(_hx_pos_9ff7555387fc5f6c_36_boot,"feathers.events.TriggerEvent","boot",0x92ab58e7,"feathers.events.TriggerEvent.boot","feathers/events/TriggerEvent.hx",36,0x10cd1a65)
namespace feathers{
namespace events{
...
void TriggerEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::hx::Null< int >  __o_touchPointID,::hx::Null< bool >  __o_isPrimaryTouchPoint,::hx::Null< Float >  __o_localX,::hx::Null< Float >  __o_localY,::hx::Null< Float >  __o_sizeX,::hx::Null< Float >  __o_sizeY,::hx::Null< Float >  __o_pressure, ::openfl::display::InteractiveObject relatedObject,::hx::Null< bool >  __o_ctrlKey,::hx::Null< bool >  __o_altKey,::hx::Null< bool >  __o_shiftKey,::hx::Null< bool >  __o_commandKey){
            	...
            	HX_STACKFRAME(&_hx_pos_9ff7555387fc5f6c_163_new)
HXLINE( 164)		super::__construct(type,bubbles,cancelable);
HXLINE( 165)		this->touchPointID = touchPointID;
HXLINE( 166)		this->isPrimaryTouchPoint = isPrimaryTouchPoint;
HXLINE( 167)		this->localX = localX;
HXLINE( 168)		this->localY = localY;
HXLINE( 169)		this->stageX = ::Math_obj::NaN;
HXLINE( 170)		this->stageY = ::Math_obj::NaN;
HXLINE( 171)		this->sizeX = sizeX;
HXLINE( 172)		this->sizeY = sizeY;
HXLINE( 173)		this->pressure = pressure;
HXLINE( 174)		this->relatedObject = relatedObject;
HXLINE( 175)		this->ctrlKey = ctrlKey;
HXLINE( 176)		this->altKey = altKey;
HXLINE( 177)		this->shiftKey = shiftKey;
HXLINE( 178)		this->commandKey = commandKey;
            	}
...
bool TriggerEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event TriggerEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_9ff7555387fc5f6c_296_clone)
HXLINE( 297)		 ::feathers::events::TriggerEvent result =  ::feathers::events::TriggerEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->touchPointID,this->isPrimaryTouchPoint,this->localX,this->localY,this->sizeX,this->sizeY,this->pressure,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->commandKey);
HXLINE( 299)		result->stageX = this->stageX;
HXLINE( 300)		result->stageY = this->stageY;
...
bool TriggerEvent_obj::dispatchFromMouseEvent(::Dynamic dispatcher, ::openfl::events::MouseEvent mouseEvent){
            	HX_STACKFRAME(&_hx_pos_9ff7555387fc5f6c_52_dispatchFromMouseEvent)
HXLINE(  57)		 ::feathers::events::TriggerEvent event = ::feathers::events::TriggerEvent_obj::_pool->get().StaticCast<  ::feathers::events::TriggerEvent >();
HXLINE(  58)		event = ::feathers::events::TriggerEvent_obj::fromMouseEvent(mouseEvent,event);
HXLINE(  59)		bool result = ::openfl::events::IEventDispatcher_obj::dispatchEvent(dispatcher,event);
HXLINE(  60)		::feathers::events::TriggerEvent_obj::_pool->release(event);
...
bool TriggerEvent_obj::dispatchFromTouchEvent(::Dynamic dispatcher, ::openfl::events::TouchEvent touchEvent){
            	HX_STACKFRAME(&_hx_pos_9ff7555387fc5f6c_74_dispatchFromTouchEvent)
HXLINE(  79)		 ::feathers::events::TriggerEvent event = ::feathers::events::TriggerEvent_obj::_pool->get().StaticCast<  ::feathers::events::TriggerEvent >();
HXLINE(  80)		event = ::feathers::events::TriggerEvent_obj::fromTouchEvent(touchEvent,event);
HXLINE(  81)		bool result = ::openfl::events::IEventDispatcher_obj::dispatchEvent(dispatcher,event);
HXLINE(  82)		::feathers::events::TriggerEvent_obj::_pool->release(event);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(TriggerEvent_obj,dispatchFromTouchEvent,return )
 ...
 ::feathers::events::TriggerEvent TriggerEvent_obj::fromMouseEvent( ::openfl::events::MouseEvent event, ::feathers::events::TriggerEvent existing){
            	HX_GC_STACKFRAME(&_hx_pos_9ff7555387fc5f6c_91_fromMouseEvent)
HXLINE(  92)		if ((event->type != HX_("click",48,7c,5e,48))) {
HXLINE(  93)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,HX_("TriggerEvent.fromMouseEvent() requires MouseEvent.CLICK",2d,e1,42,4f))));
            		}
HXLINE(  96)		if (::hx::IsNotNull( existing )) {
HXLINE(  97)			existing->type = HX_("trigger",38,55,df,25);
HXLINE(  98)			existing->bubbles = false;
HXLINE(  99)			existing->cancelable = event->cancelable;
HXLINE( 100)			existing->touchPointID = -1;
HXLINE( 101)			existing->isPrimaryTouchPoint = false;
HXLINE( 102)			existing->localX = event->localX;
HXLINE( 103)			existing->localY = event->localY;
HXLINE( 104)			existing->stageX = event->stageX;
HXLINE( 105)			existing->stageY = event->stageY;
HXLINE( 106)			existing->sizeX = ((Float)0.0);
HXLINE( 107)			existing->sizeY = ((Float)0.0);
HXLINE( 108)			existing->pressure = ((Float)1.0);
HXLINE( 109)			existing->relatedObject = event->relatedObject;
HXLINE( 110)			existing->ctrlKey = event->ctrlKey;
HXLINE( 111)			existing->altKey = event->altKey;
HXLINE( 112)			existing->shiftKey = event->shiftKey;
HXLINE( 113)			existing->commandKey = event->commandKey;
HXLINE( 114)			return existing;
            		}
HXLINE( 117)		bool event1 = event->bubbles;
HXDLIN( 117)		bool event2 = event->cancelable;
HXDLIN( 117)		Float event3 = event->localX;
HXDLIN( 117)		Float event4 = event->localY;
HXLINE( 118)		 ::openfl::display::InteractiveObject event5 = event->relatedObject;
HXDLIN( 118)		bool event6 = event->ctrlKey;
HXDLIN( 118)		bool event7 = event->altKey;
HXDLIN( 118)		bool event8 = event->shiftKey;
HXDLIN( 118)		bool result;
HXDLIN( 118)		if (::Reflect_obj::hasField(event,HX_("commandKey",14,71,9b,43))) {
HXLINE( 118)			result = event->commandKey;
            		}
            		else {
HXLINE( 118)			result = false;
            		}
HXLINE( 117)		 ::feathers::events::TriggerEvent result1 =  ::feathers::events::TriggerEvent_obj::__alloc( HX_CTX ,HX_("trigger",38,55,df,25),event1,event2,-1,false,event3,event4,((Float)0.0),((Float)0.0),((Float)1.0),event5,event6,event7,event8,result);
HXLINE( 119)		result1->stageX = event->stageX;
HXLINE( 120)		result1->stageY = event->stageY;
HXLINE( 121)		return result1;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(TriggerEvent_obj,fromMouseEvent,return )
 ...
 ::feathers::events::TriggerEvent TriggerEvent_obj::fromTouchEvent( ::openfl::events::TouchEvent event, ::feathers::events::TriggerEvent existing){
            	HX_GC_STACKFRAME(&_hx_pos_9ff7555387fc5f6c_128_fromTouchEvent)
HXLINE( 129)		if ((event->type != HX_("touchTap",e4,1b,15,00))) {
HXLINE( 130)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown( ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,HX_("TriggerEvent.fromTouchEvent() requires TouchEvent.TOUCH_TAP",b4,fd,59,ee))));
            		}
HXLINE( 133)		if (::hx::IsNotNull( existing )) {
HXLINE( 134)			existing->type = HX_("trigger",38,55,df,25);
HXLINE( 135)			existing->bubbles = false;
HXLINE( 136)			existing->cancelable = event->cancelable;
HXLINE( 137)			existing->touchPointID = event->touchPointID;
HXLINE( 138)			existing->isPrimaryTouchPoint = event->isPrimaryTouchPoint;
HXLINE( 139)			existing->localX = event->localX;
HXLINE( 140)			existing->localY = event->localY;
HXLINE( 141)			existing->stageX = event->stageX;
HXLINE( 142)			existing->stageY = event->stageY;
HXLINE( 143)			existing->sizeX = event->sizeX;
HXLINE( 144)			existing->sizeY = event->sizeY;
HXLINE( 145)			existing->pressure = event->pressure;
HXLINE( 146)			existing->relatedObject = event->relatedObject;
HXLINE( 147)			existing->ctrlKey = event->ctrlKey;
HXLINE( 148)			existing->altKey = event->altKey;
HXLINE( 149)			existing->shiftKey = event->shiftKey;
HXLINE( 150)			existing->commandKey = event->commandKey;
HXLINE( 151)			return existing;
            		}
HXLINE( 154)		 ::feathers::events::TriggerEvent result =  ::feathers::events::TriggerEvent_obj::__alloc( HX_CTX ,HX_("trigger",38,55,df,25),event->bubbles,event->cancelable,event->touchPointID,event->isPrimaryTouchPoint,event->localX,event->localY,event->sizeX,event->sizeY,event->pressure,event->relatedObject,event->ctrlKey,event->altKey,event->shiftKey,event->commandKey);
HXLINE( 156)		result->stageX = event->stageX;
HXLINE( 157)		result->stageY = event->stageY;
...
{
{
            	HX_STACKFRAME(&_hx_pos_9ff7555387fc5f6c_33_boot)
HXDLIN(  33)		TRIGGER = HX_("trigger",38,55,df,25);
            	}
{
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::feathers::events::TriggerEvent _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_9ff7555387fc5f6c_36_boot)
HXDLIN(  36)			return  ::feathers::events::TriggerEvent_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
            		}
            		HX_END_LOCAL_FUNC0(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            		void _hx_run( ::feathers::events::TriggerEvent event){
            			HX_STACKFRAME(&_hx_pos_9ff7555387fc5f6c_36_boot)
HXLINE(  37)			event->_hx___preventDefault = false;
HXLINE(  38)			event->_hx___isCanceled = false;
HXLINE(  39)			event->_hx___isCanceledNow = false;
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_9ff7555387fc5f6c_36_boot)
HXDLIN(  36)		_pool =  ::lime::utils::ObjectPool_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()), ::Dynamic(new _hx_Closure_1()),null());
            	}
}
