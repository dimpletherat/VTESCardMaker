...
HX_DEFINE_STACK_FRAME(_hx_pos_38997300b37a6a5f_87_new,"feathers.events.ScrollEvent","new",0x0f3cb488,"feathers.events.ScrollEvent.new","feathers/events/ScrollEvent.hx",87,0xb49f1e08)
HX_LOCAL_STACK_FRAME(_hx_pos_38997300b37a6a5f_91_clone,"feathers.events.ScrollEvent","clone",0x8e6b5185,"feathers.events.ScrollEvent.clone","feathers/events/ScrollEvent.hx",91,0xb49f1e08)
HX_LOCAL_STACK_FRAME(_hx_pos_38997300b37a6a5f_64_dispatch,"feathers.events.ScrollEvent","dispatch",0x6306d992,"feathers.events.ScrollEvent.dispatch","feathers/events/ScrollEvent.hx",64,0xb49f1e08)
HX_LOCAL_STACK_FRAME(_hx_pos_38997300b37a6a5f_30_boot,"feathers.events.ScrollEvent","boot",0x3dfa430a,"feathers.events.ScrollEvent.boot","feathers/events/ScrollEvent.hx",30,0xb49f1e08)
HX_LOCAL_STACK_FRAME(_hx_pos_38997300b37a6a5f_38_boot,"feathers.events.ScrollEvent","boot",0x3dfa430a,"feathers.events.ScrollEvent.boot","feathers/events/ScrollEvent.hx",38,0xb49f1e08)
HX_LOCAL_STACK_FRAME(_hx_pos_38997300b37a6a5f_45_boot,"feathers.events.ScrollEvent","boot",0x3dfa430a,"feathers.events.ScrollEvent.boot","feathers/events/ScrollEvent.hx",45,0xb49f1e08)
HX_LOCAL_STACK_FRAME(_hx_pos_38997300b37a6a5f_48_boot,"feathers.events.ScrollEvent","boot",0x3dfa430a,"feathers.events.ScrollEvent.boot","feathers/events/ScrollEvent.hx",48,0xb49f1e08)
namespace feathers{
namespace events{
...
void ScrollEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable){
            	...
            	HX_STACKFRAME(&_hx_pos_38997300b37a6a5f_87_new)
HXDLIN(  87)		super::__construct(type,bubbles,cancelable);
            	}
...
bool ScrollEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event ScrollEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_38997300b37a6a5f_91_clone)
HXDLIN(  91)		return  ::feathers::events::ScrollEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable);
            	}
...
bool ScrollEvent_obj::dispatch(::Dynamic dispatcher,::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable){
            		bool bubbles = __o_bubbles.Default(false);
            		bool cancelable = __o_cancelable.Default(false);
            	HX_STACKFRAME(&_hx_pos_38997300b37a6a5f_64_dispatch)
HXLINE(  69)		 ::feathers::events::ScrollEvent event = ::feathers::events::ScrollEvent_obj::_pool->get().StaticCast<  ::feathers::events::ScrollEvent >();
HXLINE(  70)		event->type = type;
HXLINE(  71)		event->bubbles = bubbles;
HXLINE(  72)		event->cancelable = cancelable;
HXLINE(  73)		bool result = ::openfl::events::IEventDispatcher_obj::dispatchEvent(dispatcher,event);
HXLINE(  74)		::feathers::events::ScrollEvent_obj::_pool->release(event);
...
{
{
            	HX_STACKFRAME(&_hx_pos_38997300b37a6a5f_30_boot)
HXDLIN(  30)		SCROLL_START = HX_("scrollStart",15,bd,e8,cd);
            	}
{
            	HX_STACKFRAME(&_hx_pos_38997300b37a6a5f_38_boot)
HXDLIN(  38)		SCROLL_COMPLETE = HX_("scrollComplete",e6,e9,b8,0b);
            	}
{
            	HX_STACKFRAME(&_hx_pos_38997300b37a6a5f_45_boot)
HXDLIN(  45)		SCROLL = HX_("scroll",0d,d8,64,47);
            	}
{
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::feathers::events::ScrollEvent _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_38997300b37a6a5f_48_boot)
HXDLIN(  48)			return  ::feathers::events::ScrollEvent_obj::__alloc( HX_CTX ,null(),false,false);
            		}
            		HX_END_LOCAL_FUNC0(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            		void _hx_run( ::feathers::events::ScrollEvent event){
            			HX_STACKFRAME(&_hx_pos_38997300b37a6a5f_48_boot)
HXLINE(  49)			event->_hx___preventDefault = false;
HXLINE(  50)			event->_hx___isCanceled = false;
HXLINE(  51)			event->_hx___isCanceledNow = false;
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_38997300b37a6a5f_48_boot)
HXDLIN(  48)		_pool =  ::lime::utils::ObjectPool_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()), ::Dynamic(new _hx_Closure_1()),null());
            	}
}
