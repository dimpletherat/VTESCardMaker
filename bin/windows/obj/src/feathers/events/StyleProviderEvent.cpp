...
HX_DEFINE_STACK_FRAME(_hx_pos_cca41e8d551f369a_64_new,"feathers.events.StyleProviderEvent","new",0x6d45e501,"feathers.events.StyleProviderEvent.new","feathers/events/StyleProviderEvent.hx",64,0x3bfb0f6f)
HX_LOCAL_STACK_FRAME(_hx_pos_cca41e8d551f369a_77_clone,"feathers.events.StyleProviderEvent","clone",0x657c523e,"feathers.events.StyleProviderEvent.clone","feathers/events/StyleProviderEvent.hx",77,0x3bfb0f6f)
HX_LOCAL_STACK_FRAME(_hx_pos_cca41e8d551f369a_50_dispatch,"feathers.events.StyleProviderEvent","dispatch",0x06de5279,"feathers.events.StyleProviderEvent.dispatch","feathers/events/StyleProviderEvent.hx",50,0x3bfb0f6f)
HX_LOCAL_STACK_FRAME(_hx_pos_cca41e8d551f369a_81_defaultAffectsTarget,"feathers.events.StyleProviderEvent","defaultAffectsTarget",0x51b44c6d,"feathers.events.StyleProviderEvent.defaultAffectsTarget","feathers/events/StyleProviderEvent.hx",81,0x3bfb0f6f)
HX_LOCAL_STACK_FRAME(_hx_pos_cca41e8d551f369a_31_boot,"feathers.events.StyleProviderEvent","boot",0x27fb7c71,"feathers.events.StyleProviderEvent.boot","feathers/events/StyleProviderEvent.hx",31,0x3bfb0f6f)
HX_LOCAL_STACK_FRAME(_hx_pos_cca41e8d551f369a_34_boot,"feathers.events.StyleProviderEvent","boot",0x27fb7c71,"feathers.events.StyleProviderEvent.boot","feathers/events/StyleProviderEvent.hx",34,0x3bfb0f6f)
namespace feathers{
namespace events{

void StyleProviderEvent_obj::__construct(::String type, ::Dynamic affectsTarget){
            	HX_STACKFRAME(&_hx_pos_cca41e8d551f369a_64_new)
HXLINE(  65)		super::__construct(type,null(),null());
...
HXDLIN(  66)		this->affectsTarget = _hx_tmp;
            	}
...
bool StyleProviderEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event StyleProviderEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_cca41e8d551f369a_77_clone)
HXDLIN(  77)		return  ::feathers::events::StyleProviderEvent_obj::__alloc( HX_CTX ,this->type,this->affectsTarget);
            	}
...
bool StyleProviderEvent_obj::dispatch(::Dynamic dispatcher,::String type, ::Dynamic affectsTarget){
            	HX_STACKFRAME(&_hx_pos_cca41e8d551f369a_50_dispatch)
HXLINE(  55)		 ::feathers::events::StyleProviderEvent event = ::feathers::events::StyleProviderEvent_obj::_pool->get().StaticCast<  ::feathers::events::StyleProviderEvent >();
HXLINE(  56)		event->type = type;
HXLINE(  57)		 ::Dynamic _hx_tmp;
HXDLIN(  57)		if (::hx::IsNotNull( affectsTarget )) {
HXLINE(  57)			_hx_tmp = affectsTarget;
            		}
            		else {
HXLINE(  57)			_hx_tmp = ::feathers::events::StyleProviderEvent_obj::defaultAffectsTarget_dyn();
            		}
HXDLIN(  57)		event->affectsTarget = _hx_tmp;
HXLINE(  58)		bool result = ::openfl::events::IEventDispatcher_obj::dispatchEvent(dispatcher,event);
HXLINE(  59)		::feathers::events::StyleProviderEvent_obj::_pool->release(event);
...
bool StyleProviderEvent_obj::defaultAffectsTarget(::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_cca41e8d551f369a_81_defaultAffectsTarget)
...
{
{
            	HX_STACKFRAME(&_hx_pos_cca41e8d551f369a_31_boot)
HXDLIN(  31)		STYLES_CHANGE = HX_("stylesChange",32,31,e4,f9);
            	}
{
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::feathers::events::StyleProviderEvent _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_cca41e8d551f369a_34_boot)
HXDLIN(  34)			return  ::feathers::events::StyleProviderEvent_obj::__alloc( HX_CTX ,null(),null());
            		}
            		HX_END_LOCAL_FUNC0(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            		void _hx_run( ::feathers::events::StyleProviderEvent event){
            			HX_STACKFRAME(&_hx_pos_cca41e8d551f369a_34_boot)
HXLINE(  35)			event->_hx___preventDefault = false;
HXLINE(  36)			event->_hx___isCanceled = false;
HXLINE(  37)			event->_hx___isCanceledNow = false;
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_cca41e8d551f369a_34_boot)
HXDLIN(  34)		_pool =  ::lime::utils::ObjectPool_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()), ::Dynamic(new _hx_Closure_1()),null());
            	}
}
