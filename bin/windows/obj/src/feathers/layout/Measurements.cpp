...
HXLINE(  45)		if (::Std_obj::isOfType(target,( ( ::Dynamic)(::hx::ClassOf< ::feathers::core::IMeasureObject >()) ))) {
...
HXLINE(  69)		if (::Std_obj::isOfType(target,( ( ::Dynamic)(::hx::ClassOf< ::feathers::core::IMeasureObject >()) ))) {
