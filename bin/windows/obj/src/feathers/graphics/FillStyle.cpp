...
::feathers::graphics::FillStyle FillStyle_obj::Gradient( ::Dynamic type,::Array< int > colors,::Array< Float > alphas,::Array< int > ratios, ::Dynamic radians, ::Dynamic spreadMethod, ::Dynamic interpolationMethod, ::Dynamic focalPointRatio)
{
	return ::hx::CreateEnum< FillStyle_obj >(HX_("Gradient",10,f6,f0,03),2,8)->_hx_init(0,type)->_hx_init(1,colors)->_hx_init(2,alphas)->_hx_init(3,ratios)->_hx_init(4,radians)->_hx_init(5,spreadMethod)->_hx_init(6,interpolationMethod)->_hx_init(7,focalPointRatio);
}
