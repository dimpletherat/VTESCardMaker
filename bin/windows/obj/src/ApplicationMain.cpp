...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("VTESCardMaker",08,7e,66,0d),::ApplicationMain_obj::create_dyn());
...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("48",84,2d,00,00));
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("Sewers Studio",75,66,49,6e));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("VTESCardMaker",08,7e,66,0d));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("VTESCardMaker",08,7e,66,0d));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.nbigot.vtescardmaker",9e,eb,93,25));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(7,HX_("height",e7,07,4c,02),800)
            			->setFixed(8,HX_("element",bc,ae,54,06),null())
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("VTESCardMaker",08,7e,66,0d))
...
HXLINE(  66)		attributes->__SetField(HX_("context",ef,95,77,19), ::Dynamic(::hx::Anon_obj::Create(8)
            			...
            			->setFixed(3,HX_("background",ee,93,1d,26),13421772)
