...
HXLINE(  53)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__fonts_gilb___0_ttf >());
HXLINE(  54)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__fonts_gilc_____ttf >());
HXLINE(  55)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__fonts_gili___0_ttf >());
HXLINE(  56)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__fonts_gil______ttf >());
HXLINE(  57)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__fonts_glsnecb_ttf >());
HXLINE(  58)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__fonts_quorbl___ttf >());
