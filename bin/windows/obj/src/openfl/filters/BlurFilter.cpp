...
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_177___applyFilter,"openfl.filters.BlurFilter","__applyFilter",0x511b0b88,"openfl.filters.BlurFilter.__applyFilter","openfl/filters/BlurFilter.hx",177,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_190___initShader,"openfl.filters.BlurFilter","__initShader",0xc19d1cd3,"openfl.filters.BlurFilter.__initShader","openfl/filters/BlurFilter.hx",190,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_212_get_blurX,"openfl.filters.BlurFilter","get_blurX",0xeb11be0a,"openfl.filters.BlurFilter.get_blurX","openfl/filters/BlurFilter.hx",212,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_216_set_blurX,"openfl.filters.BlurFilter","set_blurX",0xce62aa16,"openfl.filters.BlurFilter.set_blurX","openfl/filters/BlurFilter.hx",216,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_229_get_blurY,"openfl.filters.BlurFilter","get_blurY",0xeb11be0b,"openfl.filters.BlurFilter.get_blurY","openfl/filters/BlurFilter.hx",229,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_233_set_blurY,"openfl.filters.BlurFilter","set_blurY",0xce62aa17,"openfl.filters.BlurFilter.set_blurY","openfl/filters/BlurFilter.hx",233,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_246_get_quality,"openfl.filters.BlurFilter","get_quality",0xa28f7338,"openfl.filters.BlurFilter.get_quality","openfl/filters/BlurFilter.hx",246,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_250_set_quality,"openfl.filters.BlurFilter","set_quality",0xacfc7a44,"openfl.filters.BlurFilter.set_quality","openfl/filters/BlurFilter.hx",250,0x46563eac)
...
HXDLIN( 172)		return  ::openfl::filters::BlurFilter_obj::__alloc( HX_CTX ,this->_hx___blurX,this->_hx___blurY,this->_hx___quality);
 ...
 ::openfl::display::BitmapData BlurFilter_obj::_hx___applyFilter( ::openfl::display::BitmapData bitmapData, ::openfl::display::BitmapData sourceBitmapData, ::openfl::geom::Rectangle sourceRect, ::openfl::geom::Point destPoint){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_177___applyFilter)
HXLINE( 179)		int timer = ::lime::_hx_system::System_obj::getTimer();
HXDLIN( 179)		Float time;
HXDLIN( 179)		if ((timer > 0)) {
HXLINE( 179)			time = (( (Float)(timer) ) / ( (Float)(1000) ));
            		}
            		else {
HXLINE( 179)			time = ( (Float)(0) );
            		}
HXLINE( 180)		 ::lime::graphics::Image bitmapData1 = bitmapData->image;
HXDLIN( 180)		 ::lime::graphics::Image sourceBitmapData1 = sourceBitmapData->image;
HXDLIN( 180)		 ::lime::math::Rectangle finalImage = sourceRect->_hx___toLimeRectangle();
HXDLIN( 180)		 ::lime::math::Vector2 finalImage1 = destPoint->_hx___toLimeVector2();
HXDLIN( 180)		 ::lime::graphics::Image finalImage2 = ::lime::_internal::graphics::ImageDataUtil_obj::gaussianBlur(bitmapData1,sourceBitmapData1,finalImage,finalImage1,this->_hx___blurX,this->_hx___blurY,this->_hx___quality,null(),null());
HXLINE( 182)		int timer1 = ::lime::_hx_system::System_obj::getTimer();
HXDLIN( 182)		Float elapsed;
HXDLIN( 182)		if ((timer1 > 0)) {
HXLINE( 182)			elapsed = (( (Float)(timer1) ) / ( (Float)(1000) ));
            		}
            		else {
HXLINE( 182)			elapsed = ( (Float)(0) );
            		}
HXDLIN( 182)		Float elapsed1 = (elapsed - time);
HXLINE( 184)		if (::hx::IsEq( finalImage2,bitmapData->image )) {
HXLINE( 184)			return bitmapData;
            		}
HXLINE( 186)		return sourceBitmapData;
            	}


 ::openfl::display::Shader BlurFilter_obj::_hx___initShader( ::openfl::display::DisplayObjectRenderer renderer,int pass){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_190___initShader)
HXLINE( 192)		if ((pass <= this->_hx___horizontalPasses)) {
HXLINE( 194)			Float scale = ::Math_obj::pow(((Float)0.5),( (Float)((pass >> 1)) ));
HXLINE( 195)			::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value[0] = (this->get_blurX() * scale);
HXLINE( 196)			::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value[1] = ( (Float)(0) );
            		}
            		else {
HXLINE( 200)			Float scale = ::Math_obj::pow(((Float)0.5),( (Float)(((pass - this->_hx___horizontalPasses) >> 1)) ));
HXLINE( 201)			::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value[0] = ( (Float)(0) );
HXLINE( 202)			::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value[1] = (this->get_blurY() * scale);
            		}
HXLINE( 206)		return ::openfl::filters::BlurFilter_obj::_hx___blurShader;
            	}


Float BlurFilter_obj::get_blurX(){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_212_get_blurX)
HXDLIN( 212)		return this->_hx___blurX;
            	}
...
Float BlurFilter_obj::set_blurX(Float value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_216_set_blurX)
HXLINE( 217)		if ((value != this->_hx___blurX)) {
HXLINE( 219)			this->_hx___blurX = value;
HXLINE( 220)			this->_hx___renderDirty = true;
HXLINE( 221)			int _hx_tmp;
HXDLIN( 221)			if ((value > 0)) {
HXLINE( 221)				_hx_tmp = ::Math_obj::ceil(value);
            			}
            			else {
HXLINE( 221)				_hx_tmp = 0;
            			}
HXDLIN( 221)			this->_hx___leftExtension = _hx_tmp;
HXLINE( 222)			this->_hx___rightExtension = this->_hx___leftExtension;
            		}
...
Float BlurFilter_obj::get_blurY(){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_229_get_blurY)
HXDLIN( 229)		return this->_hx___blurY;
            	}
...
Float BlurFilter_obj::set_blurY(Float value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_233_set_blurY)
HXLINE( 234)		if ((value != this->_hx___blurY)) {
HXLINE( 236)			this->_hx___blurY = value;
HXLINE( 237)			this->_hx___renderDirty = true;
HXLINE( 238)			int _hx_tmp;
HXDLIN( 238)			if ((value > 0)) {
HXLINE( 238)				_hx_tmp = ::Math_obj::ceil(value);
            			}
            			else {
HXLINE( 238)				_hx_tmp = 0;
            			}
HXDLIN( 238)			this->_hx___topExtension = _hx_tmp;
HXLINE( 239)			this->_hx___bottomExtension = this->_hx___topExtension;
            		}
...
int BlurFilter_obj::get_quality(){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_246_get_quality)
...
int BlurFilter_obj::set_quality(int value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_250_set_quality)
HXLINE( 253)		int _hx_tmp;
HXDLIN( 253)		if ((this->_hx___blurX <= 0)) {
HXLINE( 253)			_hx_tmp = 0;
            		}
            		else {
HXLINE( 253)			_hx_tmp = (::Math_obj::round((this->_hx___blurX * (( (Float)(value) ) / ( (Float)(4) )))) + 1);
            		}
HXDLIN( 253)		this->_hx___horizontalPasses = _hx_tmp;
HXLINE( 254)		int _hx_tmp1;
HXDLIN( 254)		if ((this->_hx___blurY <= 0)) {
HXLINE( 254)			_hx_tmp1 = 0;
            		}
            		else {
HXLINE( 254)			_hx_tmp1 = (::Math_obj::round((this->_hx___blurY * (( (Float)(value) ) / ( (Float)(4) )))) + 1);
            		}
HXDLIN( 254)		this->_hx___verticalPasses = _hx_tmp1;
