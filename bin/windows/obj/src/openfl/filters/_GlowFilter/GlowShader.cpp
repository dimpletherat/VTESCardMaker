...
HX_DEFINE_STACK_FRAME(_hx_pos_3849ff18b8ccdd38_433_new,"openfl.filters._GlowFilter.GlowShader","new",0x65561d5f,"openfl.filters._GlowFilter.GlowShader.new","openfl/filters/GlowFilter.hx",433,0x5f568606)
...
void GlowShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_3849ff18b8ccdd38_433_new)
...
HXLINE( 434)		super::__construct(null());
HXLINE( 437)		this->uRadius->value = ::Array_obj< Float >::fromData( _hx_array_data_a0ce81ed_1,2);
HXLINE( 438)		this->uColor->value = ::Array_obj< Float >::fromData( _hx_array_data_a0ce81ed_2,4);
HXLINE( 386)		this->_hx___isGenerated = true;
HXDLIN( 386)		this->_hx___initGL();
            	}
