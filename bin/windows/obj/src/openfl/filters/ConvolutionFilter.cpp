...
HX_DEFINE_STACK_FRAME(_hx_pos_1c37e03b5548415e_213_new,"openfl.filters.ConvolutionFilter","new",0xfeba0f71,"openfl.filters.ConvolutionFilter.new","openfl/filters/ConvolutionFilter.hx",213,0x8cb91f21)
HX_LOCAL_STACK_FRAME(_hx_pos_1c37e03b5548415e_231_clone,"openfl.filters.ConvolutionFilter","clone",0x5c23f8ae,"openfl.filters.ConvolutionFilter.clone","openfl/filters/ConvolutionFilter.hx",231,0x8cb91f21)
HX_LOCAL_STACK_FRAME(_hx_pos_1c37e03b5548415e_235___initShader,"openfl.filters.ConvolutionFilter","__initShader",0x77456c44,"openfl.filters.ConvolutionFilter.__initShader","openfl/filters/ConvolutionFilter.hx",235,0x8cb91f21)
HX_LOCAL_STACK_FRAME(_hx_pos_1c37e03b5548415e_249_get_matrix,"openfl.filters.ConvolutionFilter","get_matrix",0x1d18db19,"openfl.filters.ConvolutionFilter.get_matrix","openfl/filters/ConvolutionFilter.hx",249,0x8cb91f21)
HX_LOCAL_STACK_FRAME(_hx_pos_1c37e03b5548415e_253_set_matrix,"openfl.filters.ConvolutionFilter","set_matrix",0x2096798d,"openfl.filters.ConvolutionFilter.set_matrix","openfl/filters/ConvolutionFilter.hx",253,0x8cb91f21)
...
void ConvolutionFilter_obj::__construct(::hx::Null< int >  __o_matrixX,::hx::Null< int >  __o_matrixY,::Array< Float > matrix,::hx::Null< Float >  __o_divisor,::hx::Null< Float >  __o_bias,::hx::Null< bool >  __o_preserveAlpha,::hx::Null< bool >  __o_clamp,::hx::Null< int >  __o_color,::hx::Null< Float >  __o_alpha){
            	...
            	HX_STACKFRAME(&_hx_pos_1c37e03b5548415e_213_new)
HXLINE( 214)		super::__construct();
HXLINE( 216)		this->matrixX = matrixX;
HXLINE( 217)		this->matrixY = matrixY;
HXLINE( 218)		this->_hx___matrix = matrix;
HXLINE( 219)		this->divisor = divisor;
HXLINE( 220)		this->bias = bias;
HXLINE( 221)		this->preserveAlpha = preserveAlpha;
HXLINE( 222)		this->clamp = clamp;
HXLINE( 223)		this->color = color;
HXLINE( 224)		this->alpha = alpha;
HXLINE( 226)		this->_hx___numShaderPasses = 1;
            	}
...
bool ConvolutionFilter_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::filters::BitmapFilter ConvolutionFilter_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_1c37e03b5548415e_231_clone)
HXDLIN( 231)		return  ::openfl::filters::ConvolutionFilter_obj::__alloc( HX_CTX ,this->matrixX,this->matrixY,this->_hx___matrix,this->divisor,this->bias,this->preserveAlpha,this->clamp,this->color,this->alpha);
            	}


 ::openfl::display::Shader ConvolutionFilter_obj::_hx___initShader( ::openfl::display::DisplayObjectRenderer renderer,int pass){
            	HX_STACKFRAME(&_hx_pos_1c37e03b5548415e_235___initShader)
HXLINE( 237)		::openfl::filters::ConvolutionFilter_obj::_hx___convolutionShader->uConvoMatrix->value = this->get_matrix();
HXLINE( 238)		::openfl::filters::ConvolutionFilter_obj::_hx___convolutionShader->uDivisor->value[0] = this->divisor;
HXLINE( 239)		::openfl::filters::ConvolutionFilter_obj::_hx___convolutionShader->uBias->value[0] = this->bias;
HXLINE( 240)		::openfl::filters::ConvolutionFilter_obj::_hx___convolutionShader->uPreserveAlpha->value[0] = this->preserveAlpha;
HXLINE( 243)		return ::openfl::filters::ConvolutionFilter_obj::_hx___convolutionShader;
            	}


::Array< Float > ConvolutionFilter_obj::get_matrix(){
            	HX_STACKFRAME(&_hx_pos_1c37e03b5548415e_249_get_matrix)
HXDLIN( 249)		return this->_hx___matrix;
            	}
...
::Array< Float > ConvolutionFilter_obj::set_matrix(::Array< Float > v){
            	HX_STACKFRAME(&_hx_pos_1c37e03b5548415e_253_set_matrix)
HXLINE( 254)		if (::hx::IsNull( v )) {
HXLINE( 256)			v = ::Array_obj< Float >::fromData( _hx_array_data_75e782ff_5,9);
            		}
HXLINE( 259)		if ((v->length != 9)) {
HXLINE( 261)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Only a 3x3 matrix is supported",f2,31,34,62)));
            		}
HXLINE( 264)		return (this->_hx___matrix = v);
            	}
