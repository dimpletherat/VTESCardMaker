...
HXLINE( 481)					if (::hx::IsNotEq( existingChild,targetChild )) {
...
HXDLIN( 519)						_g = (_g + 1);
HXLINE( 521)						if (::hx::IsEq( instance->displayObject,child1 )) {
...
HXDLIN( 702)						_g = (_g + 1);
HXLINE( 704)						if (::hx::IsEq( frameObject->type,::openfl::_internal::symbols::timeline::FrameObjectType_obj::CREATE_dyn() )) {
...
HXDLIN(1025)		if (::hx::IsEq( ( ( ::openfl::display::MovieClip)(event->target) ),::hx::ObjectPtr<OBJ_>(this) )) {
