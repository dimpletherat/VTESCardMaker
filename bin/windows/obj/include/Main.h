...
class HXCPP_CLASS_ATTRIBUTES Main_obj : public  ::openfl::display::Sprite_obj
{
	...
	public:
		...
		::String __ToString() const { return HX_("Main",59,64,2f,33); }
		 ...
		 ::openfl::text::Font _cardTextFont;
		 ::Card _card;
		 ::feathers::controls::ComboBox _cbClan;
		void _addedToStageHandler( ::openfl::events::Event e);
		::Dynamic _addedToStageHandler_dyn();

		void comboBox_changeHandler( ::openfl::events::Event event);
		::Dynamic comboBox_changeHandler_dyn();
