...
class FillStyle_obj : public ::hx::EnumBase_obj
{
	...
	public:
		...
		static ::feathers::graphics::FillStyle Gradient( ::Dynamic type,::Array< int > colors,::Array< Float > alphas,::Array< int > ratios, ::Dynamic radians, ::Dynamic spreadMethod, ::Dynamic interpolationMethod, ::Dynamic focalPointRatio);
