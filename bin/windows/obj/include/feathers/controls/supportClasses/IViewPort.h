...
class HXCPP_CLASS_ATTRIBUTES IViewPort_obj {
	public:
		...
		bool (::hx::Object :: *_hx_get_requiresMeasurementOnScroll)(); 
		static inline bool get_requiresMeasurementOnScroll( ::Dynamic _hx_) {
			return (_hx_.mPtr->*( ::hx::interface_cast< ::feathers::controls::supportClasses::IViewPort_obj *>(_hx_.mPtr->_hx_getInterface(0xd5cd7712)))->_hx_get_requiresMeasurementOnScroll)();
		}
};
