...
class HXCPP_CLASS_ATTRIBUTES BasicToggleButton_obj : public  ::feathers::core::FeathersControl_obj
{
	...
	public:
		...
		static ::hx::ObjectPtr< BasicToggleButton_obj > __new();
		static ::hx::ObjectPtr< BasicToggleButton_obj > __alloc(::hx::Ctx *_hx_ctx);
		...
		static  ::Dynamic __meta__;
		 ::feathers::controls::ToggleButtonState currentState;
		...
		bool keepDownStateOnRollOut;
		 ...
		 ::openfl::display::DisplayObject selectedBackgroundSkin;
		...
		virtual void basicToggleButton_triggerHandler( ::feathers::events::TriggerEvent event);
