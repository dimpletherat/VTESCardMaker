...
class HXCPP_CLASS_ATTRIBUTES ArrayCollection_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		bool _pendingRefresh;
		 ::Dynamic filterFunction;
		Dynamic filterFunction_dyn() { return filterFunction;}
		...
		::Dynamic set_filterFunction_dyn();
		 ...
		 ::Dynamic sortCompareFunction;
		Dynamic sortCompareFunction_dyn() { return sortCompareFunction;}
