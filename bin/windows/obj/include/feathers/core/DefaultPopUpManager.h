...
class HXCPP_CLASS_ATTRIBUTES DefaultPopUpManager_obj : public ::hx::Object
{
	...
	public:
		...
		bool _ignoreRemoval;
		 ::openfl::display::DisplayObjectContainer root;
		...
		::Array< ::Dynamic> _centeredPopUps;
		 ...
		 ::Dynamic overlayFactory;
		Dynamic overlayFactory_dyn() { return overlayFactory;}
		...
		void popUp_removedFromStageHandler( ::openfl::events::Event event);
		::Dynamic popUp_removedFromStageHandler_dyn();

		void popUp_resizeHandler( ::openfl::events::Event event);
		::Dynamic popUp_resizeHandler_dyn();

		void stage_resizeHandler( ::openfl::events::Event event);
		::Dynamic stage_resizeHandler_dyn();
