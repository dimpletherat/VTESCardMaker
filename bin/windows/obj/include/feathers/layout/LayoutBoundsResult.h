...
HX_DECLARE_STACK_FRAME(_hx_pos_860434864bed074c_16_new)
...
HXLINE(  38)		( ( ::feathers::layout::LayoutBoundsResult)(__this) )->contentY = ((Float)0.0);
HXLINE(  30)		( ( ::feathers::layout::LayoutBoundsResult)(__this) )->contentX = ((Float)0.0);
            	}
